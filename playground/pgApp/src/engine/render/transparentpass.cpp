...
pgTransparentPass::pgTransparentPass(const pgPassCreateInfo& ci)
	: base(ci)
{
	LoadTexture();
...
pgTransparentPass::~pgTransparentPass()
{
}

void pgTransparentPass::CreatePipelineState()
{
...
void pgTransparentPass::LoadTexture()
{
...
// Render a frame
void pgTransparentPass::render(pgRenderEventArgs& e) {
...
void pgTransparentPass::update(pgRenderEventArgs& e) {
	//
}

void pgTransparentPass::updateSRB(pgRenderEventArgs& e) {

#include "PipelineFPTransparent.h"

using namespace Diligent;

PipelineFPTransparent::PipelineFPTransparent(std::shared_ptr<pgRenderTarget> rt) : base(rt)
{
    LoadTexture();
    CreatePipelineState();
}

PipelineFPTransparent::~PipelineFPTransparent() {}

void PipelineFPTransparent::CreatePipelineState()
{
    ...
    ShaderResourceVariableDesc Vars[] = { { SHADER_TYPE_PIXEL, "g_Texture",
    ...
    StaticSamplerDesc StaticSamplers[] = { { SHADER_TYPE_PIXEL, "g_Texture", SamLinearClampDesc } };
...
void PipelineFPTransparent::LoadTexture()
{

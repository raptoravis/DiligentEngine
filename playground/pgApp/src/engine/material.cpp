...
Diligent::ITexture* Material::GetTexture(TextureType type) const
{
...
void Material::SetTexture(TextureType type, Diligent::ITexture* texture)
{
...
static bool isTransparentTexture(Diligent::ITexture* texture) {
	return false;
}
...
bool Material::IsTransparent() const
{
	return (m_pProperties->m_Opacity < 1.0f ||
		...
		(m_pProperties->m_HasDiffuseTexture && isTransparentTexture(GetTexture(TextureType::Diffuse)) ) ||
